...
var HardContextDependency4 = require('./dependencies').HardContextDependency4;
...
HardBasicDependencyPlugin.prototype.apply = function(compiler) {
    ...
    if (dependency instanceof ContextDependency) {
      if (dependency.options) {
        return {
          ...
          hadGlobalOrStickyRegExp: dependency.hadGlobalOrStickyRegExp,
  ...
  pluginCompat.tap(compiler, '_hardSourceThawDependency', 'HardBasicDependencyPlugin', function(dependency, frozen, extra) {
    if (frozen.type === 'ContextDependency') {
      if (frozen.options) {
        dependency = new HardContextDependency4(Object.assign(
          {},
          frozen.options,
          {
            regExp: frozen.regExp ? new RegExp(frozen.regExp) : false,
          }
        ));
