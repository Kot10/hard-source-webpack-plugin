...
module.exports = {
  ...
  HardContextDependency4: HardContextDependency4,
...
function HardContextDependency4(options) {
  Object.setPrototypeOf(this,
    Object.setPrototypeOf(
      new ContextDependency(options),
      HardContextDependency4.prototype
    )
  );
}
Object.setPrototypeOf(HardContextDependency4.prototype, ContextDependency.prototype);
Object.setPrototypeOf(HardContextDependency4, ContextDependency);

if (CriticalDependencyWarning) {
  HardContextDependency4.prototype.getWarnings = function() {
    if(this.critical) {
      return [
        new CriticalDependencyWarning(this.critical)
      ];
